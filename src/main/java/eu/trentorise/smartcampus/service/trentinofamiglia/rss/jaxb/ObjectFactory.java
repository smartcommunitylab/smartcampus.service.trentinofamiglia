 ...
 * generated in the eu.trentorise.smartcampus.service.trentinofamiglia.rss.jaxb package. 
...
public class ObjectFactory {
    ...
    private final static QName _RssItemPubDate_QNAME = new QName("", "pubDate");
    private final static QName _RssItemTitle_QNAME = new QName("", "title");
    private final static QName _RssItemCategory_QNAME = new QName("", "category");
    ...
    private final static QName _RssItemDescription_QNAME = new QName("", "description");
    private final static QName _RssItemLink_QNAME = new QName("", "link");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: eu.trentorise.smartcampus.service.trentinofamiglia.rss.jaxb
     * 
     */
    ...
    public JAXBElement<String> createRssItemPubDate(String value) {
        return new JAXBElement<String>(_RssItemPubDate_QNAME, String.class, RssItem.class, value);
    }
    ...
    public JAXBElement<String> createRssItemTitle(String value) {
        return new JAXBElement<String>(_RssItemTitle_QNAME, String.class, RssItem.class, value);
    }
    ...
    public JAXBElement<Category> createRssItemCategory(Category value) {
        return new JAXBElement<Category>(_RssItemCategory_QNAME, Category.class, RssItem.class, value);
    }
    ...
    public JAXBElement<String> createRssItemDescription(String value) {
        return new JAXBElement<String>(_RssItemDescription_QNAME, String.class, RssItem.class, value);
    }
    ...
    public JAXBElement<String> createRssItemLink(String value) {
        return new JAXBElement<String>(_RssItemLink_QNAME, String.class, RssItem.class, value);
    }
    ...
    public JAXBElement<String> createRssChannelPubDate(String value) {
        return new JAXBElement<String>(_RssItemPubDate_QNAME, String.class, RssChannel.class, value);
    }
    ...
    public JAXBElement<String> createRssChannelLink(String value) {
        return new JAXBElement<String>(_RssItemLink_QNAME, String.class, RssChannel.class, value);
    }
    ...
    public JAXBElement<Category> createRssChannelCategory(Category value) {
        return new JAXBElement<Category>(_RssItemCategory_QNAME, Category.class, RssChannel.class, value);
    }
    ...
    public JAXBElement<String> createRssChannelTitle(String value) {
        return new JAXBElement<String>(_RssItemTitle_QNAME, String.class, RssChannel.class, value);
    }
    ...
    public JAXBElement<String> createRssChannelDescription(String value) {
        return new JAXBElement<String>(_RssItemDescription_QNAME, String.class, RssChannel.class, value);
    }
